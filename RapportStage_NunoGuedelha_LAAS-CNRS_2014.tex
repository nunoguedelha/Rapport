...
\begin{figure}[H]
\begin{center}
  \subfloat[Equivalence des vecteurs de translation.]{\includegraphics[width=5cm, page=4]{figs/figures}}\hspace{1cm}
  \subfloat[Visualisation de $\textbf{d}_{Py}$ et $\textbf{d}_{Pz}$ en $O$.]{\includegraphics[width=5cm, page=5]{figs/figures}}\hspace{1cm}
  \subfloat[Expression des vecteurs de rotation dans $D_{O}$]%
  {
  \begin{minipage}{5cm} \hfill
    \begin{align*}
...
Nous nous intéressons à présent aux forces appliquées au corps rigide $\emph{C}$. Soit une force quelconque appliquée au solide. On la décompose en une somme:
\begin{itemize}
